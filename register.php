        ...
        <div class="col mt-sma-3">
          <div class="form-cotainer">
            ...
            <form method="post" id="RegForm">
              ...
              <input type="password" placeholder="Conferma Password" name="password_2">
              <div class="bot_reg_log mt-1">
                <button type="submit" class="btn btn small-text text_w " name="reg_user">Register</button>
              </div>


            </form>
            <a class="a small-text"  href="login.php">Sei già iscritto?</a>
